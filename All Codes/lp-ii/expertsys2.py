...
# Add flights
expert_system.add_flight("F001", "London", "New York", "09:00", "15:00")
expert_system.add_flight("F002", "Paris", "Tokyo", "12:00", "22:00")
expert_system.add_flight("F003", "New York", "London", "10:30", "16:30")

# Add cargoes
expert_system.add_cargo("C001", "London", "New York", "10:00")
expert_system.add_cargo("C002", "Paris", "Tokyo", "13:00")
expert_system.add_cargo("C003", "New York", "London", "12:00")
...
cargo_source = input("Enter the source airport: ")
cargo_destination = input("Enter the destination airport: ")
